    ...
    <div class="form-signin mx-auto">
        <form>
            <div class="container-sm shadow p-5" data-bs-theme="dark">
                <h1 class="h3 mb-3 fw-normal  text-center text-secondary">Авторизуйтесь</h1>
                ...
                <button @click.prevent="sendFormData" type="submit" class="btn w-100 btn-lg btn-outline-info">Войти</button>
            </div>
        </form>
    </div>
</template>
